<template>
  <div>
    ...
    <v-layout v-show="!metamaskInstalled"
      style="background-color: #F44336; color: white; padding: 25px; text-align: center;" justify-center align-center
      row wrap>
    ...
    <v-layout v-show="metamaskInstalled" style=" color: white; padding: 25px; text-align: center;" justify-center
    ...
    <v-layout v-show="false"
      style=" color: white; padding: 25px; text-align: center;     background-color: rgb(3, 46, 66);" justify-center
      align-center row wrap>
      <v-flex style="height:100%; padding-bottom:20px;" xs12 sm12 md12>
